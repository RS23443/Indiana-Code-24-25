...
public final class Constants {
    ...
    public static final double[] outtakeSampleReset = {0.48,0.52,0.98,0.89};
    /*
    ...
    */
    ...
    public static final double[] outtakeSampleDrop = {0.7,0.3,0.35,0.65};
    /*
     ...
     */
    public static final double[] outtakeSpecimenReset = {0.85,0.15,0.4,0.85};
    /*
    this is will cause the outtake arm to grab and flip outwards ready to deposit Sample
    ...
    public static final double[] outtakeSpecimenDrop = {0.5,0.5,0.2,0.65,0.6,0.4,0};
    /*
    this is will cause the outtake arm to grab and flip outwards ready to deposit Sample
