package pedroPathing.Robot.Camera.Pipelines; // Make sure this package matches your FTC project structure
...
public class ContrastAndROI extends OpenCvPipeline {
    ...
    public static Scalar LOWER_YELLOW_HSV = new Scalar(10, 50, 50); // Lower HSV threshold for yellow
    public static Scalar UPPER_YELLOW_HSV = new Scalar(50, 255, 255); // Upper HSV threshold for yellow
