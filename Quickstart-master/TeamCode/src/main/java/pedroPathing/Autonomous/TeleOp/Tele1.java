    ...
    public void runOpMode() throws InterruptedException {
            ...
            if (currentGamepad1LeftBumperState && !lastGamepad1LeftBumperState) {
                ...
                switch (currentState) {
                    case INTAKE:
                        ...
                        new PDFLCommand(lifts, 1550).schedule();
        ...
        /*if(isIntakeReadyToTransfer){
            ...
            if (gamepad1.x) {
                ...
                intake.setServoPosition(6, Constants.intakeActive[4]);
                sleep(150);
                deposit.setServoPosition(1, Constants.outtakeSampleDrop[0]-0.15);
                deposit.setServoPosition(2, Constants.outtakeSampleDrop[1]+0.15);
                deposit.setServoPosition(3, Constants.outtakeSampleDrop[2]-0.05);
