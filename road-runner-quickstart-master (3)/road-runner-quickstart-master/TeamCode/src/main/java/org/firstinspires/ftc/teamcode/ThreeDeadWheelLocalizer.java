...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2059.63089265; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2059.63089265; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 1624.4823513; // x position of the perpendicular encoder (in tick units)
    }
